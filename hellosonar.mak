...
TARGET         = hellosonar
OBJS           = AEEModGen.o AEEAppGen.o HelloSonar.o GCCResolver.o 
...
#-----------------------------------------------------------------------
LINK_CMD  = -T$(GCCRESOLVEPATH)\elf2mod.x --emit-relocs -entry AEEMod_Load -o
LIBS		=	-lgcc
...
$(TARGET).$(MODULE) :   $(TARGET).$(EXETYPE)
	$(ELF2MODTOOL) $(OUTPUT) $(TARGET).$(MODULE) $(TARGET).$(EXETYPE)
...
..\..\src\aeeappgen.o: ../../src/aeeappgen.c \
  $(BREWDIR)/inc/aee.h \
  $(BREWDIR)/inc/aeegroupids.h \
  $(BREWDIR)/inc/aeeclassids.h \
  $(BREWDIR)/inc/aeeclsid_filemgr.bid \
  $(BREWDIR)/inc/aeeerror.h \
  $(BREWDIR)/inc/aeecomdef.h \
  $(BREWDIR)/inc/aeeinterface.h \
  $(BREWDIR)/inc/aeequeryinterface.h \
  ...
  $(BREWDIR)/inc/aeeresourcectl.h \
  $(BREWDIR)/inc/aeecontrols_res.h \
  $(BREWDIR)/inc/aeelngcode.h \
  $(BREWDIR)/inc/aeestdlib.h \
  c:/gnude/lib/gcc-lib/arm-elf/3.3.1/include/stddef.h \
  $(BREWDIR)/inc/aeeoldvalist.h \
  c:/gnude/lib/gcc-lib/arm-elf/3.3.1/include/stdarg.h \
  $(BREWDIR)/inc/aeeappgen.h \
  $(BREWDIR)/inc/aeemodgen.h \
  $(BREWDIR)/inc/nmdef.h
..\..\src\aeemodgen.o: ../../src/aeemodgen.c \
  $(BREWDIR)/inc/aeeheap.h \
  $(BREWDIR)/inc/aee.h \
  $(BREWDIR)/inc/aeegroupids.h \
  $(BREWDIR)/inc/aeeclassids.h \
  $(BREWDIR)/inc/aeeclsid_filemgr.bid \
  ...
  $(BREWDIR)/inc/aeeappgen.h \
  $(BREWDIR)/inc/nmdef.h
.\src\hellosonar.o: src/hellosonar.c \
  $(BREWDIR)/inc/aeemodgen.h \
  $(BREWDIR)/inc/aee.h \
  $(BREWDIR)/inc/aeegroupids.h \
  $(BREWDIR)/inc/aeeclassids.h \
  ...
  $(BREWDIR)/inc/aeeoldvalist.h \
  c:/gnude/lib/gcc-lib/arm-elf/3.3.1/include/stdarg.h \
  $(BREWDIR)/inc/aeeaddrbook.h \
  $(BREWDIR)/inc/aeedb.h \
  $(BREWDIR)/inc/addrbook_ruim.bid \
  $(BREWDIR)/inc/aeetapi.h \
  $(BREWDIR)/inc/aeeweb.h \
  $(BREWDIR)/inc/aeesource.h \
  $(BREWDIR)/inc/aeenet.h \
  $(BREWDIR)/inc/aeenetworktypes.h \
  $(BREWDIR)/inc/net_urgent.bid \
  $(BREWDIR)/inc/aeewebopts.h \
  $(BREWDIR)/inc/aeefile.h hellosonar.bid \
  hellosonar_res.h src/defines.h
